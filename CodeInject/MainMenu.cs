...
namespace CodeInject
{
    public unsafe partial class MainMenu : Form
    {
        ...
        {
            callActionFuncx64((new IntPtr((long)(Process.GetCurrentProcess().MainModule.BaseAddress.ToInt64() + 0x277D680)).ToPointer()), 1, actionId, targetId, 0, 0, 0);
        }
        ...
        public MainMenu()
        {
            ...
            //x64
            playerState = (int*)(new IntPtr((long)(Process.GetCurrentProcess().MainModule.BaseAddress.ToInt64() + 0x275F6C0)).ToPointer());

            //00007FF6497AFFF0 | E8 AB353300              | call ffxiv_dx11.7FF649AE35A0            |
            callActionFuncx64 = (CallActionx64)Marshal.GetDelegateForFunctionPointer(new IntPtr((long)(Process.GetCurrentProcess().MainModule.BaseAddress.ToInt64() + 0xB6ef20)), typeof(CallActionx64));
        }
        ...
        {
            ActionCommandx64((int)Action.Bait);
